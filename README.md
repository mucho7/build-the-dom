...
서비스는 KBO 다이아고딕을 사용합니다. 글꼴의 지적 재산권은 (사)한국야구위원회에 있으며, 공식 배포본을 수정하지 않고 포함했습니다. 개인·기업의 웹사이트 사용과 재배포가 허용되지만 글꼴 자체의 수정·개작 및 판매는 금지됩니다. 자세한 조건은 [KBO 다이아고딕 라이선스](https://www.koreabaseball.com/Reference/etc/KboFont.aspx)를 확인하세요.
